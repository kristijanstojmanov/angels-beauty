        ...
        <section className="py-24 bg-background-alt text-text-main-light">
            <div className="container mx-auto px-6 max-w-4xl">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-display font-bold text-primary mb-4">{t('faq.title')}</h2>
                    <p className="text-text-muted-light">{t('faq.subtitle')}</p>
                </div>
                ...
                <div className="bg-white rounded-3xl p-8 md:p-12 text-center shadow-lg border border-gray-50">
                    <h3 className="text-2xl font-bold font-display mb-2">{t('faq.stillHaveQuestions')}</h3>
                    <p className="text-text-muted-light mb-8">{t('faq.helpText')}</p>
